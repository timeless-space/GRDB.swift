Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/timeless-space/GRDB.swift.git'
  s.author   = { 'Gwendal Roué' => 'gr@pierlis.com' }
  s.source   = { :git => 'https://github.com/timeless-space/GRDB.swift.git', :tag => "v#{s.version}" }
  s.module_name = 'GRDB'
